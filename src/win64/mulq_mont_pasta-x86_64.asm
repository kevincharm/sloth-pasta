...
PUBLIC	sqr_n_mul_mont_255


ALIGN	32
sqr_n_mul_mont_255	PROC PUBLIC
	DB	243,15,30,250
	mov	QWORD PTR[8+rsp],rdi	;WIN64 prologue
	mov	QWORD PTR[16+rsp],rsi
	mov	r11,rsp
$L$SEH_begin_sqr_n_mul_mont_255::
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
	mov	rcx,r9
...
$L$SEH_epilogue_sqr_n_mul_mont_255::
	mov	rdi,QWORD PTR[8+rsp]	;WIN64 epilogue
	mov	rsi,QWORD PTR[16+rsp]

	DB	0F3h,0C3h		;repret

$L$SEH_end_sqr_n_mul_mont_255::
sqr_n_mul_mont_255	ENDP
...
ALIGN	4
	...
	DD	imagerel $L$SEH_begin_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_body_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqr_n_mul_mont_255_prologue

	DD	imagerel $L$SEH_body_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_epilogue_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqr_n_mul_mont_255_body

	DD	imagerel $L$SEH_epilogue_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_end_sqr_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqr_n_mul_mont_255_epilogue
...
$L$SEH_info_sqr_n_mul_mont_255_prologue::
DB	1,0,5,00bh
DB	0,074h,1,0
DB	0,064h,2,0
DB	0,003h
DB	0,0
$L$SEH_info_sqr_n_mul_mont_255_body::
DB	1,0,17,0
...
DB	000h,0a2h
DB	000h,000h
$L$SEH_info_sqr_n_mul_mont_255_epilogue::
DB	1,0,4,0
DB	000h,074h,001h,000h
DB	000h,064h,002h,000h
DB	000h,000h,000h,000h
