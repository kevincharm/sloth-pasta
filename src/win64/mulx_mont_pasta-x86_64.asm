...
PUBLIC	sqrx_n_mul_mont_255


ALIGN	32
sqrx_n_mul_mont_255	PROC PUBLIC
	DB	243,15,30,250
	mov	QWORD PTR[8+rsp],rdi	;WIN64 prologue
	mov	QWORD PTR[16+rsp],rsi
	mov	r11,rsp
$L$SEH_begin_sqrx_n_mul_mont_255::
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
	mov	rcx,r9
...
$L$SEH_body_sqrx_n_mul_mont_255::
...
$L$oop_sqrx_255::
	...
	mulx	rbx,r9,QWORD PTR[((16+128))+r8]
	adcx	r12,r9
	adox	r13,rbx
	...
	mulx	rdi,r9,QWORD PTR[((16+128))+r8]
	adcx	rbp,r9
	adox	rdi,r10
	...
	sbb	rcx,QWORD PTR[8+r8]
	sbb	r13,QWORD PTR[16+r8]
	mov	rbx,r14
	sbb	r14,QWORD PTR[24+r8]
...
$L$SEH_epilogue_sqrx_n_mul_mont_255::
	mov	rdi,QWORD PTR[8+rsp]	;WIN64 epilogue
	mov	rsi,QWORD PTR[16+rsp]

	DB	0F3h,0C3h		;repret

$L$SEH_end_sqrx_n_mul_mont_255::
sqrx_n_mul_mont_255	ENDP
...
ALIGN	4
	...
	DD	imagerel $L$SEH_begin_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_body_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqrx_n_mul_mont_255_prologue

	DD	imagerel $L$SEH_body_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_epilogue_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqrx_n_mul_mont_255_body

	DD	imagerel $L$SEH_epilogue_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_end_sqrx_n_mul_mont_255
	DD	imagerel $L$SEH_info_sqrx_n_mul_mont_255_epilogue
...
$L$SEH_info_sqrx_n_mul_mont_255_prologue::
DB	1,0,5,00bh
DB	0,074h,1,0
DB	0,064h,2,0
DB	0,003h
DB	0,0
$L$SEH_info_sqrx_n_mul_mont_255_body::
DB	1,0,17,0
...
DB	000h,0a2h
DB	000h,000h
$L$SEH_info_sqrx_n_mul_mont_255_epilogue::
DB	1,0,4,0
DB	000h,074h,001h,000h
DB	000h,064h,002h,000h
DB	000h,000h,000h,000h
